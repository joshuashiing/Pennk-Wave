...
def main():
    ...
    data1 = sio.loadmat('testQ_case01.mat')
    data2 = sio.loadmat('testQ_case02.mat')
    data3 = sio.loadmat('testQ_case03.mat')
    data4 = sio.loadmat('testQ_case04.mat')
    ...
    plt.text(10, 30, r'(a) $Q=\infty$ (Acoustic)', fontsize=12)
    plt.text(400, 30, r'(b) $Q=100$', fontsize=12)
    plt.text(10, 500, r'(c) $Q=30$', fontsize=12)
    plt.text(400, 500, r'(d) $Q=10$', fontsize=12)
