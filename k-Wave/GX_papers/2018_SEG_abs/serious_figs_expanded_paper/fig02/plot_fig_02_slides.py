...
def main():
    ...
    ax1.set_xlim(10, 60)
    ax1.yaxis.set_ticks(np.linspace(2, 2.15, 4))
    ...
    plt.text(10.3, 2.13, r'$Q=100$', fontsize=11)
    fig.savefig('slide_fig02a1.png', dpi=300)
    ...
    fig.savefig('slide_fig02a2.png', dpi=300)
    #
    #
    # tmp_scale = 1e5
