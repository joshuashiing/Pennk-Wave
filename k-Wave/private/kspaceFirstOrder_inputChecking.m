...
elseif isfield(medium, 'mod_mech')
    ...
    elseif strcmp(medium.mod_mech, 'FD111111')
        equation_of_state = 'absorbing_FD111111';  
    elseif strcmp(medium.mod_mech, 'GXFD0')
        equation_of_state = 'absorbing_GXFD0';
    end
% elseif isfield(medium, 'mod_mech')
...
elseif ~strcmp(equation_of_state, 'absorbing_TZ14') && ...
        ...
        ~strcmp(equation_of_state, 'absorbing_FD111111') && ...
        ~strcmp(equation_of_state, 'absorbing_GXFD0')
% elseif ~strcmp(equation_of_state, 'absorbing_TZ14') && ...
%         ~strcmp(equation_of_state, 'absorbing_TZ17') && ...
